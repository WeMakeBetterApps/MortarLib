...
public abstract class MortarActivity extends Activity implements PauseAndResumeActivity {
  ...
  @Inject PauseAndResumePresenter mPauseAndResumePresenter;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    Blueprint activityScope = getNewActivityScope();
    ...
    mPauseAndResumePresenter.takeView(this);
  }
  ...
  @Override protected void onResume() {
    super.onResume();
    mIsRunning = true;
    mPauseAndResumePresenter.activityResumed();
  }

  @Override protected void onPause() {
    mIsRunning = false;
    super.onPause();
    mPauseAndResumePresenter.activityPaused();
  }
